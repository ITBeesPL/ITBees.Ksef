...
public class KsefCredentialIm
{
    ...
    /// <summary>
    /// Contents of the certificate file, Base64 encoded. Either a PKCS#12 container (.p12/.pfx)
    /// or — together with <see cref="PrivateKeyPemBase64"/> — a PEM certificate (.crt/.pem)
    /// exactly as generated by the KSeF certificate wizard.
    /// </summary>
    public string? CertificateBase64 { get; set; }

    /// <summary>
    /// Contents of the PEM private key file (.key), Base64 encoded. Filled only when
    /// <see cref="CertificateBase64"/> carries a PEM certificate instead of a PKCS#12 container;
    /// the pair is converted to PKCS#12 server-side before being stored.
    /// </summary>
    public string? PrivateKeyPemBase64 { get; set; }

    /// <summary>Password of the PKCS#12 container, or of the encrypted PEM private key.</summary>
